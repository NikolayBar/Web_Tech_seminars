...
$jobExp = [
	[
        ...
        'jstart' => 'Январь 2015',
        'jend' => 'Сейчас',
        'descr' => 'Лорем ипсум долор сит амет. Уважительная причина для нахождения в безлюдном месте достойна порицания
        Я здесь. Клянусь, никого не волнует, что она меня ненавидит.'
    ],
	[
    	'name' => 'Web Developer / something.com',
        'jstart' => 'Март 2012',
        'jend' => 'Декабрь 2014',
        'descr' => 'Прилагательные элиты. Уважительная причина для нахождения в безлюдном месте достойна порицания
        Я здесь. Клянусь, никого не волнует, что она меня ненавидит.'
    ],
    ...
    [
        ...
        'jstart' => 'Июнь 2010',
        'jend' => 'Март 2012',
        'descr' => 'Лорем ипсум долор сит амет, прилагательные элита.'
    ]
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <?php for($i=0 ; $i < count($jobExp); $i++): ?>
              <?php echo $jobExp[$i]['name']?></b></h5>
            
              <h6 class="w3-text-teal">
              <i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $jobExp[$i]['jstart']?> - 
              <span class="w3-round">               
              <?php echo $jobExp[$i]['jend']?></span></h6>
              <p>
              <?php echo $jobExp[$i]['descr']?>
              </p>
              <hr>
			      <?php endfor; ?>
  	        <!-- ЦИКЛ -->
